...
namespace Sparky {
    ...
    VulkanRenderer::VulkanRenderer() : instance(nullptr), physicalDevice(nullptr), device(nullptr), 
                                       ...
                                       swapChain(nullptr), renderPass(nullptr), pipelineLayout(nullptr), 
    ...
    bool VulkanRenderer::initialize(void* windowHandle) {
        ...
        try {
            SPARKY_LOG_INFO("Initializing Vulkan renderer...");
            createInstance();
            setupDebugMessenger();
            createSurface();
            pickPhysicalDevice();
            ...
            SPARKY_LOG_ERROR("Failed to initialize Vulkan: " + std::string(e.what()));
            return false;
        }
    }
    ...
    void VulkanRenderer::cleanup() {
        ...
        SPARKY_LOG_INFO("Vulkan renderer cleaned up");
    }
    ...
    void VulkanRenderer::render() {
        SPARKY_LOG_DEBUG("Starting VulkanRenderer::render()");
        vkWaitForFences(device, 1, &inFlightFence, VK_TRUE, UINT64_MAX);
        
        SPARKY_LOG_DEBUG("Fence wait completed");
        ...
        uint32_t imageIndex;
        SPARKY_LOG_DEBUG("About to acquire next image");
        ...
        SPARKY_LOG_DEBUG("Image acquired, index: " + std::to_string(imageIndex));
        
        // Update uniform buffer
        updateUniformBuffer(imageIndex);
        
        SPARKY_LOG_DEBUG("Uniform buffer updated");
        
        vkResetFences(device, 1, &inFlightFence);
        
        SPARKY_LOG_DEBUG("Fence reset");
        
        vkResetCommandBuffer(commandBuffers[imageIndex], 0);
        recordCommandBuffer(commandBuffers[imageIndex], imageIndex);
        
        SPARKY_LOG_DEBUG("Command buffer recorded");
        ...
        SPARKY_LOG_DEBUG("About to submit command buffer");
        if (vkQueueSubmit(graphicsQueue, 1, &submitInfo, inFlightFence) != VK_SUCCESS) {
            throw std::runtime_error("failed to submit draw command buffer!");
        }
        
        SPARKY_LOG_DEBUG("Command buffer submitted");
        ...
        SPARKY_LOG_DEBUG("About to present");
        ...
        SPARKY_LOG_DEBUG("Present completed");
        
        currentFrame = (currentFrame + 1) % MAX_FRAMES_IN_FLIGHT;
        SPARKY_LOG_DEBUG("Frame completed");
    }
    ...
    void VulkanRenderer::createInstance() {
        ...
        appInfo.pApplicationName = "Sparky Engine";
        appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
        appInfo.pEngineName = "Sparky Engine";
...
#else
            // Add other platform-specific extensions as needed
#endif
        };
        ...
        SPARKY_LOG_INFO("Vulkan instance created");
    }
    ...
    void VulkanRenderer::createLogicalDevice() {
        ...
        SPARKY_LOG_INFO("Logical device created");
    }
    ...
    void VulkanRenderer::createSwapChain() {
        ...
        SPARKY_LOG_INFO("Swap chain created with " + std::to_string(imageCount) + " images");
    }
    ...
    void VulkanRenderer::createImageViews() {
        ...
        SPARKY_LOG_INFO("Image views created");
    }
    ...
    void VulkanRenderer::createRenderPass() {
        ...
        SPARKY_LOG_INFO("Render pass created");
    }
    ...
    void VulkanRenderer::createCommandPool() {
        ...
        SPARKY_LOG_INFO("Command pool created");
    }
    ...
    void VulkanRenderer::createGraphicsPipeline() {
        ...
        SPARKY_LOG_INFO("Executable path: " + exePath);
        SPARKY_LOG_INFO("Executable directory: " + exeDir);
        
        // Paths where shaders might be located, in order of priority
        // Add the current working directory as the first search path
        std::vector<std::string> searchPaths = {
            "./Engine/shaders/",                            // Relative to current working directory
        ...
        for (size_t i = 0; i < searchPaths.size(); ++i) {
            ...
            bool vertExists = Sparky::FileUtils::fileExists(vertPath);
            bool fragExists = Sparky::FileUtils::fileExists(fragPath);
            SPARKY_LOG_INFO("Vertex shader exists: " + std::to_string(vertExists));
            SPARKY_LOG_INFO("Fragment shader exists: " + std::to_string(fragExists));
        ...
        if (!found) {
            SPARKY_LOG_ERROR("Failed to find shader files in any of the search paths!");
        ...
        SPARKY_LOG_INFO("Creating shader modules");
        VkShaderModule vertShaderModule = createShaderModule(vertShaderCode);
        VkShaderModule fragShaderModule = createShaderModule(fragShaderCode);
        SPARKY_LOG_INFO("Shader modules created successfully");
        ...
        if (vkCreatePipelineLayout(device, &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS) {
            SPARKY_LOG_ERROR("Failed to create pipeline layout!");
        ...
        SPARKY_LOG_INFO("About to create graphics pipeline");
    ...
    VkExtent2D VulkanRenderer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
        if (capabilities.currentExtent.width != UINT32_MAX) {
            ...
            return actualExtent;
#else
            // Fallback implementation when GLFW is not available
            VkExtent2D actualExtent = {
                std::max(capabilities.minImageExtent.width, std::min(capabilities.maxImageExtent.width, 800u)),
    ...
    void VulkanRenderer::createDepthResources() {
        ...
        SPARKY_LOG_INFO("Depth resources created");
    }
    ...
    void VulkanRenderer::createFramebuffers() {
        ...
        SPARKY_LOG_INFO("Framebuffers created");
    }
    ...
    void VulkanRenderer::createCommandBuffers() {
        ...
        SPARKY_LOG_INFO("Command buffers allocated");
    }

    void VulkanRenderer::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        SPARKY_LOG_DEBUG("Starting recordCommandBuffer");
        VkCommandBufferBeginInfo beginInfo{};
        beginInfo.sType = VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO;
        ...
        SPARKY_LOG_DEBUG("Command buffer begin successful");
        ...
        SPARKY_LOG_DEBUG("Render pass begun");
        
        vkCmdBindPipeline(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipeline);
        
        SPARKY_LOG_DEBUG("Pipeline bound");
        ...
        SPARKY_LOG_DEBUG("Render pass ended");
        
        if (vkEndCommandBuffer(commandBuffer) != VK_SUCCESS) {
            throw std::runtime_error("failed to record command buffer!");
        }
        
        SPARKY_LOG_DEBUG("Command buffer recording completed");
    }
    ...
    void VulkanRenderer::createSyncObjects() {
        ...
        SPARKY_LOG_INFO("Synchronization objects created");
    }
    ...
    void VulkanRenderer::createUniformBuffers() {
        ...
        SPARKY_LOG_INFO("Uniform buffers created");
    }
    
    void VulkanRenderer::cleanupUniformBuffers() {
        ...
        SPARKY_LOG_INFO("Uniform buffers cleaned up");
    }
    ...
    void VulkanRenderer::createDescriptorPool() {
        ...
        SPARKY_LOG_INFO("Descriptor pool created");
    }
...
// Fallback implementation when Vulkan/GLFW is not available
#include "../include/VulkanRenderer.h"
#include "../include/Logger.h"
#include <stdexcept>
#include <iostream>
